...
*Figure 1. Study-oriented architecture of the maintained VGGT implementation.*
...
*Figure 2. Evidence ladder from official inference reproduction to held-out adaptation comparison.*
...
*Figure 3. P000 frames 20–29 form nested S2, S4, S6, S8, and S10 conditions.*
...
*Figure 4. Endpoint and overlap-aware delivery_area pairs.*
...
*Figure 5. Representative RGB, predicted depth, point confidence, and confidence-filtered point cloud for the overlap-aware S10 condition.*
...
*Figure 6. Representative RGB, predicted depth, point confidence, and confidence-filtered point cloud for the overlap-aware S10 condition.*
...
*Figure 7. Scale-aligned depth AbsRel across the fixed nested subsets.*
...
*Figure 8. Spearman association between point confidence and absolute depth error. More negative is better.*
...
*Figure 9. Single recorded inference time and peak allocated memory.*
...
*Figure 10. Training-sample and fixed P006 validation objectives.*
...
*Figure 11. Adaptation slightly lowers RMSE while degrading AbsRel and δ1.25.*
...
- One checkpoint produces cameras, depth, confidence, point maps, and tracks on real and synthetic inputs.
- ETH3D outputs preserve coherent scene-level structure in indoor and outdoor examples.
...
- Ten-view inference and bounded backpropagation fit the RTX 5080 memory envelope.

## Observed weaknesses

- Geometry changes non-monotonically along the fixed nested sequence.
- Confidence/error ranking degrades and changes sign at S10.
- Thin structures, difficult surfaces, and weak overlap remain visually fragile.
- Short head-only adaptation over-specializes relative depth behavior.
...
Official inference was reproduced, varied real and synthetic inputs were tested, and measurable strengths and weaknesses were identified. Bounded adaptation was attempted under a split-safe protocol, and its negative held-out result was retained. The evidence supports careful metric-specific interpretation, not broad generalization. A fixed S2/S6/S10 comparison in a second synthetic environment is the clearest next evaluation.
